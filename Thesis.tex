...
Until now, we've seen how technology has reshaped the practice of collage in interesting ways.  We now focus on collage-based practitioners that do not just make use of existing technology, but also write their own software.  Such practitioners are often the creators of algorithms and offer new ways of procedurally manipulating media.  In many veins, these practices make use of techniques in synthesis, which, across a range of computational practices, describes a technique for creating media.  In sound, this can mean generating soundscapes (e.g. \cite{Schwarz2010,Schwarz2011}), entire phrases of music (e.g. \cite{a}), vowels (e.g. \cite{a}), or even entire phrases of speech (e.g. \cite{Moulines1990}).  For visual applications, similarly, synthesis can describe a variety of approaches for computationally generating images describing types of textures or patterns (e.g. \cite{Cohen2000}), artistic renderings (e.g. \cite{a}), or for video, dynamic textures such as clouds or fire (e.g. \cite{Schodl2000}).  In this section, we limit our review of this expansive field to practices specifically described by collage-based techniques which therefore also require the use of existing content.
...
In this Chapter, we build a computational implementation of visual scene analysis.  This aims to encode any number of visual scenes, represent them using representations motivated in our conceptual framework in Chapter \ref{ch:conceptual-visual}, and decode any target visual scene.  This process will be used within a collage-based arts practice to open a dialogue surrounding the nature of perception in the Chapter \ref{ch:synthesis-visual} and combined with a similar model of audio in Chapter \ref{ch:audiovisual}.  

\section{Related Work}

\hl{Background of computational visual models.}
...
\begin{subfigure}{0.32\textwidth}
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-2.png}
\end{subfigure}
\begin{subfigure}{0.32\textwidth}
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-3.png}
\end{subfigure}
\end{figure}
...
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-5.png}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-4.png}
\end{subfigure}

\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-6.png}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
\centering
\includegraphics[width=\textwidth]{images/visual-memory-mosaic-7.png}
\end{subfigure}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{images/vam-questionnaire-1.png}
\end{figure}
\begin{figure}
\centering
\includegraphics[width=\textwidth]{images/vam-questionnaire-2.png}
\end{figure}
...
An American Law student, Dean Carter, at Georgetown University produced the following essay for one of his courses in copyright law.  The document was entitled, ``Analysis of Potential Copyright Violations in PKMITAL SMASH-UPS'' and is reproduced in its entirety below:
...
\section{VIOLATIONS OF 17 U.S.C. \S{}106 ``EXCLUSIVE RIGHTS IN COPYRIGHTED WORK''}
...
\section{Sound Recording, Composition, Audiovisual Work?}
...
\section{17 U.S.C. \S{}107: ``LIMITATIONS ON EXCLUSIVE RIGHTS: FAIR USE''}
...
\section{Amount and Substantiality of the Portion Used}
...
\section{Effect on the Potential Market}
