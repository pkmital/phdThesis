...
\include{TitlePage}
 \cleardoublepage
 \section*{Declaration}
I declare that the work presented in this thesis is my own unless otherwise stated. \\
...
I have had the fortune in life to share the genuine company, wisdom, and support of many people.  They have constantly challenged me and inspired me beyond ways I cannot begin to describe here.  I hope to continue to use the energy they have given me in the future for realizing the potential of many more people.  During my High School, Seifert's class was a haven for learning about computers and expression in a place otherwise devoid of any possible hope.  Following graduation, Sherol first pushed me to explore research and introduced me both to Dr. Bohacek with whom I first explored research and the McNair Scholars program where I met the exceptionally inspiring and caring Dr. P.  It was during these years that Meg continued (and continues) to teach me through her own discovery of balancing biology (indian parents) and poetry (life).  I met countless friends, Dean, Deepthi, Miraj, Manish, Jared, and Sara who are still family to me.  Dr. Kambhamettu's computer vision and graphics courses marked an eye-opening development in my education, and I can't thank him enough for pushing me to take Dr. Yu's post-graduate seminar on computational photography, even though I was just a bachelor's student.  

Dr P also first bought me Curtis Road's Computer Music Tutorial and sent me to New Orleans to attend the 2006 ICMC.  I had no idea how much I would hate the music but love what was being done to it.  Being able to discuss with Max Matthews and Tae Hong Park amongst others as a completely naive student was truly life changing.  It eventually took me to California to attend the Stanford CCRMA and Berkeley CNMAT summer schools where I met a whole cast of inspiring and influential people. Perry Cook gave me the advice of pursuing a more technological field despite me wanting to go into an interdisciplinary practice.  That advice pushed me to go to Edinburgh and study Artificial Intelligence.  Perhaps the hardest year of my life, I met some of the most talented teachers including Bob Fisher and Chris Williams.  It was in Edinburgh where I shared a flat with Koosha, and was introduced to never-ending armchair discussions which certainly developed my logical thinking and interest for cognition and analytical philosophy.  

Edinburgh was also where I met Tim Smith. To this day, he has been an unwavering and refreshing source of inspiration and friendship.  He supervised my first art project developing eye-tracking into an algorithmically edited film, perhaps my first use of computational audiovisual scene synthesis.  He also supervised my master's project getting me to see the potential of computer vision techniques for exploring behavior as measured through eye-tracking and encouraged me on to the DIEM project.  His support through this project and numerous others has been profoundly positive.  I can't thank him enough for being genuinely interested in what he does and helping me to realize my own potentials.  It was while with DIEM that I had the pleasure to work with the truly insightful John Henderson. During his discussions and the lab's weekly meetings, I learned an incredible amount about both visual cognition and what it meant to be part of a research lab.

During these years in Edinburgh, I explored just as much outside of academia as within it thanks to Agelos and the incredible community of friends I made while there, including Rocio, Sean, Dave, Owen, Sarah, Christos, Paul, Marcin, etc... The friends I have made there including Sharath, Koosha, and Maral are always in my thoughts.  Agelos pushed me to develop an artwork for a glasshouse, Memory, which went on to be exhibited in London and Athens numerous times.  It was while exhibiting in London that we met Gareth and Jonathan who mark a pivotal point in my life.  They introduced me to London's art scene and believed in the potential of our artwork.  It was at Kinetica where they worked in order to invite us where I also met Patrick Tresset and first learned of Goldsmiths Computing Department.  Months later I was applying and in contact with the energetic Mick Grierson who now supervises this thesis.  Mick's enthusiasm and untraditional approach to nearly everything opened my eyes and challenged me constantly.  I can't thank him enough for the inspiration, patience, and guidance he's given me throughout this thesis.  My friends in London during this time, Bruno, Baptiste, Enrica, Phil, Kristine, Api, Negar, and so many more have been a source of joy and support through both good and bad times.

John Lee and Matthew Fuller were both rigorous and thoughtful in their reading of this thesis and during my defense.  I thank them immensely for their careful reading and invaluable comments to make this a stronger thesis.
...
Omissions are inevitable in the last hours that I write this thesis so I hope that you forgive me if I've excluded you.  Of course I cannot leave out my loving wife Sharareh.  People would often ask me why I'm not in tears or going crazy while writing up and I must say it's because of her.
...
This section situates the thesis within a lineage of collage-based practices starting with seminal developments in collage, montage, cut-up, and musique concr\`ete, before moving to an overview of developments in technology that radically changed collage practice in terms of its practice, publishing, distribution, and even legality.  This coarse review will ashamedly not have the space to go into each of practice's differences in aesthetic concerns or modes of operation.  No attempt will be made to analyze these practices further than the point of having used collage-like techniques.  The intention here is rather to offer to the reader a general perspective on the many practices employing collage-based techniques, as this technique is essential to this thesis's exploration of the meaning-making process.
...
The juxtaposition of fragments of sound as an arts practice has roots at least as early as musique concr\`ete, a compositional technique assembling various natural found sounds in order to produce a collage of sound.  Digital Sampling came in the 1970's allowing sound segments to be triggered using an interface such as a keyboard or pad.  More recent techniques have focused on corpus-based concatenative synthesis, where a target sound is matched to a stored database of segments or sounds (for a more comprehensive review, see Section \ref{sec:collage-beginnings}).  In this thesis, we focus on a collage-based technique called scene synthesis which assembles units created through the computational modeling of psychologically motivated representations thought to support perception.  The aim in building these units and re-assembling them within a collage-based practice is to open a dialogue into the nature of representation within perception.  
...
\section{User Feedback}\label{sec:synthesis-audio-results}
...
\section{Background Literature on Visual Perception}\label{sec:conceptual-visual-background}
...
\begin{figure}
  ...
  \caption{Van Gogh's ``Bedroom in Arles'' is synthesized using 3 images of Monet paintings to produce the image on the bottom. Images representing faithful reproductions of Van Gogh and Claude Monet sourced from \href{http://commons.wikimedia.org}{Wikimedia Commons} are public domain.}
...
\noindent\begin{minipage}[t]{0.5\linewidth}
    ...
    \item{Detect attention map using the magnitude of the optical flow (see Section \ref{sec:optical-flow} for details)}
    \item{Detect proto-objects in the candidate video frames (using the original image for Weeks 1 - 6; using the filtered image from the visual acuity map for Week 7+, as discussed in Section \ref{sec:visual-acuity})}
    \item{Encode objects higher than threshold by storing a descriptor of its shape, color, and original video content (see Section \ref{sec:proto-objects} for details}
    \end{itemize}
    \end{minipage}%
    ...
    \item{Detect attention map using the magnitude of the optical flow (see Section \ref{sec:optical-flow} for details)}
    \item{Detect proto-objects in the target video frames (using the original image for Weeks 1 - 6; using the filtered image from the visual acuity map for Week 7+, as discussed in Section \ref{sec:visual-acuity})}
    \item{Decode objects higher than threshold using the closest matching descriptor of its shape and color, transforming the matched candidate video frame's proto-object to the target video frame's proto-object (see Section \ref{sec:proto-objects} for details)}
    \end{itemize}
...
This thesis has investigated scene synthesis, an approach for computationally generating audiovisual collages.  The objective of developing scene synthesis has been to explore its ability to produce new meanings from existing audiovisual content, as well as to explore the meaning making process within our own perceptual systems.   Specific to this collage process was the use of psychologically motivated pre-attentive representations which are thought to support our ongoing perception of the world.  We focused on this particular representation in order to better understand what have previously been theorized and conceptualized as representations unconscious to us, though which are necessary to our ability to understand the world.  As they are unconscious to us, we do not have access to them directly.  Scene synthesis however has shown to be one possible method towards building a better understanding of pre-attentive, unconscious representations used in perception.  

To aid in the development of scene synthesis, we borrowed two commonly used terms from coding and compression literature: \textit{encoding} and \textit{decoding} (discussed in greater length in Section \ref{sec:coding}).  In the context of scene synthesis, we described encoding by the processes of analyzing and subsequently storing or learning pre-attentive representations.  Decoding is then the process which attempts to synthesize any target audio file, image, or video by matching any detected representations to ones that have already been encoded.  The development of the encoding and decoding processes of scene synthesis were conceptualized and developed modularly, where audio was developed independently of vision, and only in the later chapters, combined, though still kept as independent frameworks.  

For audio, we discussed the notion of the auditory event within the context of auditory streaming as a pre-attentive auditory representation in Chapter \ref{ch:conceptual-audio}.  This representation was motivated after reviewing presiding theories in cognitive neuroscience and experimental psychology such as streaming paradigms and evidence of event-related potentials such as the N1, processing negativity (PN), object relative negativity (ORN), and mismatch negativity (MMN).  This body of research has demonstrated the importance of temporal irregularities in the ongoing auditory scene in order to detect events and discretize the continuous amalgamation of sounds where updates in representations or selective attention processes may occur.  After reviewing this literature, we developed a conceptual framework for auditory scene analysis with the intention of being able to computationally implement it.  This framework encompassed four processes: \textit{event detection}, as demonstrated by various event-related potentials; the N1 component; \textit{matching}, as evidenced by the PN component; \textit{segregation}, as evidenced by the MMN and ORN components; and finally \textit{integration}, the encoding process which stores the result of the event detection.  

The latter three components were developed computationally in Chapter \ref{ch:analysis-audio}.  We saw here that a model developed using MFCCs or PLCA was capable of encoding and decoding acoustic events with significantly greater than chance performance.  However, when presented more complex acoustic events, such as those masked by noise, or described by mixtures of many events, the MFCC model performance suffered, while the PLCA model still performed very well.  

Our computational framework was extended in Chapter \ref{ch:synthesis-audio} to encompass a much larger and more complex corpus and to also begin exploring alternative decoding procedures in an interactive, performative, and 3D graphical browser of the corpus of the Daphne Oram Archive.  We invited researchers of the archive to explore the browser using the various models we have developed, one using MFCCs and another using PLCA.  The question we asked was whether the visual form created by either model had significant benefits for its exploration.  Results from our qualitative feedback suggested the form of the PLCA model when compared to the MFCC model encompassed an easier to navigate structure, a more intuitive mapping in the 3-dimensional space, and sounds were more clustered and similarly sounding when placed closer together in the 3-dimensional space.  User feedback further suggested that their experience using the browser was ``really successful'', in that they were able to learn about Daphne Oram's own practice, stating, ``it seems to be matching pitch and you start to see how she was using pitch'' (for more feedback see Section \ref{sec:synthesis-audio-results}).

The last component of our conceptual framework for audio scene analysis, event detection, was not computationally developed until we investigated real-time auditory scene synthesis in Chapter \ref{ch:memory-mosaic}.  This was integrated into an application released to the Apple App Store called ``Memory Mosaic''.  Based on the limited reviews of the app, user feedback suggested that the application provided a "fascinating'', 'beautiful and thought provoking audio landscape'', which make one ``more aware about [their] own personal audio environment.''  

For visual scene synthesis, we reviewed literature in visual perception in Section \ref{sec:conceptual-visual-background} covering early theories such as Rubin's thesis on figure/ground separation and Gestalt psychology, visual attention literature on exo/endogenous influences, effects of priming, early scene recognition as demonstrated by gist, spatial scene layout, change and in attentional blindness, and finally visual object representation.  This research demonstrated the important of an active viewing of a visual scene, where the movements of the eye are a necessary act to encode with higher spatial detail the point of a fixation.  This is in contrast to many existing models of visual saliency which assume an entire visual scene is encoded with high spatial detail, thus ignoring the function of the eye.   In order to simulate the focus of attention, we also motivated the development a model of visual attention.  Our previous research showed that a model of optical flow performed better than a corpus of visual features found in most saliency models and used this as our model of attention.  Finally, our conceptual framework encompassed three components: \textit{exogenous attention}, as demonstrated by our previous work in dynamic scene viewing; \textit{visual acuity}, as demonstrated by the physiology of the eye; and \textit{proto-objects}, a volatile, color and shape-based representation of a region of a scene.  

Combining the three components, the collection of proto-objects encode a visual scene using an encoding with a higher resolution at points of a scene likely to fixated, with lower resolutions outside of these points.  We saw how this could developed computationally in Chapter \ref{ch:analysis-visual}.  Proto-objects were detected using a well known computer vision algorithm for region detection, maximally stable color regions (MSCR).  The scale of these regions were first effected by a visual acuity filter created using a series of Gaussian blurs simulating the logarithmic falloff in spatial acuity of the eye.  The point of highest spatial acuity was determined by a model of exogenous attention, computationally developed using a model of optical flow.  

We saw how this framework could be extended to produce decodings or visual scene syntheses in Chapter \ref{ch:synthesis-visual}.  We first experimented with the use of scene synthesis for producing artistic stylizations of an image or image sequence.   This work focused the interaction of the matching process on the representations of the proto-objects.  This is in contrast to many existing algorithms for artistic stylization which either operate as a filter, i.e. using the target image/sequence and applying a filter onto the data, thus transforming its values to another space, or to work in example-based approaches which do in fact use a corpus of existing images.  The significant difference in our work is that the representation which we have chosen has been motivated by visual perception theory.  This meant focusing the user interaction on the process of encoding and decoding the proto-objects, rather than any preset notion of ``style'' or ``genre'' of aesthetics.  In this regard, using images encoding Monet does not necessarily mean the scene synthesis has encoded the style of Monet (unlike most existing approaches for artistic stylization).   Rather, the set of parameters effecting the encoding and decoding of the proto-objects are what effect the possible aesthetic outputs.  

We also experimented with the same framework without any parameters in an iOS application ``PhotoSynthesizer''  in order to try to attract a larger number of users to the process of visual scene synthesis.  The application was modeled as a ``painting application'', which demonstrated the process of scene synthesis in a series of stages.  First, a user picks a target image or takes a new image using their webcam.  They can then pick a set of images from their Photo Library which the app states will be used as the pallet of ``paint''.  Finally, the synthesis is drawn with one proto-object at a time, starting from the coarser background proto-objects, and finishing with the finer, higher spatial detail proto-objects.  
% add more about visual computational

% add more about visual synthesis

After developing these frameworks computationally, we saw how scene synthesis could be applied in both an online and offline setting.  For an online setting, we developed scene synthesis to aggregate a database in a process called \textit{Memory Mosaicing}.  We also applied this within an augmented reality allowing a user to be entirely immersed within the scene synthesis in \textit{Augmented Reality Hallucinations}.  Feedback from participants showed they found that the aesthetics were associated with different painterly movements.  They also found themselves thinking of the process of perception itself.
...
One particular question that research has not yet addressed is how a measure of attention in audio, i.e. if such a measure triggers an N100, or event detection, can be used to alter a visual or spatial map, or vice-versa?  Some preliminary research was taken to investigate whether a simple model could be built with the developments in this thesis.  We composed a video of existing experimental abstract films in a 2x2 grid and tracked participants watching the film for their eye-movements.  The idea was to train a measure of synchrony between the audio attention and visual attention predictions in the computational models using the eye-movements as the optimal measure (view the video with eye-movements overlaid as a heatmap visualization here \url{https://vimeo.com/69392361}).  However, the abstract nature of the clips means that there is not much agreement in where people tend to focus their gaze.  

We investigated a similar idea in a film by Michael Figgis', \textit{Timecode}, where people, conversations, known locations, and other semantic factors may have affected the measure of synchrony and early attentional influences.  The film is an ideal case for the study of audiovisual attention as the director himself would often perform the audio track during festival film screenings in order to shift the gaze of viewers.  This preliminary research was presented at the Society for the Cognitive Studies of the Moving Image (SCSMI) in 2012 in my talk entitled, ``Audiovisual influences in Michael Figgis' Timecode'', though has not progressed farther than preliminary research.  There are a number of additional questions that will be asked by exploring the results of these experiments in the years to come.
