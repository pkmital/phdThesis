...
This chapter presented the work of \textit{YouTube Smash Up}, a short film series producing audiovisual scene syntheses of the number 1 YouTube video using the remaining top 10 videos.  Though it is difficult to describe an artwork's result, as may be necessary within the context of a practice-based PhD, some result may be described by the work being sought out by curators.  Having been invited to the Media Art Histories 2013 conference in particular, as part of the ART+COMMUNICATION exhibition offered a unique perspective on the work.  
