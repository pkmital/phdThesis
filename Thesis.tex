...
For 5 weeks starting in late September of 2012, we synthesized the number 1 most viewed video on YouTube after learning the audiovisual content from the remaining top 10 videos.  The idea was to continue to do so until one of the synthesized videos ended up in the top 10, thus resynthesizing itself.  However, after week 5, I was no longer able to log into my YouTube account and was redirected to a page\footnote{\url{http://www.youtube.com/copyright_school}} with an animation of \textit{Happy Tree Friends} explaining what copyright is and how to avoid risking copyright infringement.   Accompanying the animation was a quiz testing my knowledge of copyright which I had to correctly complete in order to use my account.  
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{images/copyright-school-img.png}
\caption{An example still from the animation of \textit{Happy Tree Friends} teaching the infringer about copyright law.}
\end{figure}
...
\appendix
\chapter{Appendix1: YouTube Smash Up Videos}
