...
An example of one of the more interesting outputs demonstrating its potential is shown in Figure \ref{fig:augmented-reality-keys}.  As the learning process for learning proto-objects is restrictive, not every proto-object detected is learned.  Rather, only ones with a great enough distance in shape and color are learned.  In this example, the keyboard letters have been detected, only 1 has been learned, and all have been synthesized by a single keyboard letter.  
