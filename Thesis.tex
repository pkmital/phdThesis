...
Though we've considered approaches employing computers and software, this section is dedicated to reviewing approaches making use of computation based in algorithms, rather than computation using existing software.  As a result, this literature is mostly defined by the creators of software.  In order to situate this literature, it is important to briefly consider seminal developments within cybernetics, signal processing, and information theory beginning in the 1940's.  This literature will help to shape the similarities between collage and information sciences, further offering the terminology of encoding and decoding as another way of understanding collage within the context of this thesis.

\subsubsection{Information Theory and the Birth of Modern Computing}
...
\subsubsection{Algorithmic and Generative Art}

\hl{Lev Manovich's Soft Cinema, \url{https://en.wikipedia.org/wiki/Database_cinema}}
...
\hl{do I need to define scene, encoding, and decoding, before the next chapter?}
...
\hl{mention will talk about it in chapter 8}
