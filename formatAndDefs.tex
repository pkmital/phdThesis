...
\fancyheadoffset[LE, RE, LO, RO]{2cm}
\fancyfootoffset[LE, RE, LO, RO]{2cm}
\fancyhead[LE]{\makebox[2cm][l]{\bfseries\thepage}}    % Page number (boldface) in left on even
\fancyhead[RO]{\makebox[2cm][r]{\bfseries\thepage}}    % Page number (boldface) in left on even
% pages and right on odd pages
%\fancyhead[RE]{\bfseries\nouppercase{\leftmark}}      % Chapter in the right on even pages
%\fancyhead[LO]{\bfseries\nouppercase{\rightmark}}     % Section in the left on odd pages
%\fancyfoot[RE,LO]{\bfseries{Parag K. Mital | Computational Audiovisual Scene Synthesis}}
\fancyhead[RE]{\makebox[2cm][r]{\bfseries\nouppercase{\rightmark}}}     % Section in the left on odd pages
\fancyhead[LO]{\makebox[2cm][l]{\bfseries\nouppercase{\rightmark}}}     % Section in the left on odd pages
\fancyfoot[LO]{\makebox[2cm][l]{\bfseries\nouppercase{\leftmark}}}
\fancyfoot[RE]{\makebox[2cm][r]{\bfseries\nouppercase{\leftmark}}}
\fancyfoot[LE]{\makebox[2cm][l]{\bfseries\thepage}}    % Page number (boldface) in left on even
\fancyfoot[RO]{\makebox[2cm][r]{\bfseries\thepage}}    % Page number (boldface) in left on even
